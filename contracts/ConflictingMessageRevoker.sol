...
contract ConflictingMessageRevoker{
    ...
    public
    {
		...
		require(LibSecp256k1Sha256.verifySignMsg(m_appCert.appKeyAddr, message1, message1SigR, message1SigS), "message1 signature invalid");
		require(LibSecp256k1Sha256.verifySignMsg(m_appCert.appKeyAddr, message2, message2SigR, message2SigS), "message2 signature invalid");
